...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5773687944 6119769857 6072149828 6205528551').split()]
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'krownlinks.in')
