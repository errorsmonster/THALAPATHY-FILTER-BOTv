...
async def auto_pm_fill(b, m):
    if PMFILTER:       
        if G_FILTER:
            ...
            if kd == False: await auto_filter(b, m)
        else: await auto_filter(b, m)
    else: return 
